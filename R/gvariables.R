...
addArg = function(argument,iwidget,container = NULL, toolkit=guiToolkit()) {
  ...
  obj = new("gAddargRGtk",block=group, widget=iwidget, toolkit=toolkit,
    argument=argument)
  return(obj)
}
...
setMethod(".svalue",
          signature(toolkit="guiWidgetsToolkitRGtk2",obj="gAddargRGtk"),
          function(obj, toolkit, index=NULL, drop=NULL,  ...) {
            ...
            if(val == "") {
              return(NA)
                      ...
                      is(obj@widget,"gEditListRGtk") ||
                      is(obj@widget,"gEditNamedListRGtk") ||
                      arg == "...") {
              return(val)
            } else {
...
gunivariate = function(xlabel="x",container=NULL, ..., toolkit=guiToolkit()) {
  ...
  obj = new("gUnivariateRGtk",block=frame, widget=frame, toolkit=toolkit, widgets=list(xarg))
  return(obj)
}
...
#  adddroptarget(xentry, handler = basicdrophandler)
  ...
  obj = new("gBivariateRGtk",block=frame, widget=frame,toolkit=toolkit, widgets=list(xarg,yarg))
  return(obj)
}

setMethod(".svalue",
          signature(toolkit="guiWidgetsToolkitRGtk2",obj="gBivariateRGtk"),
          function(obj, toolkit, index=NULL, drop=NULL, ...) {
...
#  adddroptarget(responseEntry, handler=responseDropHandler)
  ...
  obj = new("gModelRGtk",block=frame,widget=frame,
    toolkit=toolkit,
    widgets =
...
setMethod(".svalue",
          signature(toolkit="guiWidgetsToolkitRGtk2",obj="gModelRGtk"),
          function(obj, toolkit,index=NULL, drop=NULL, ...) {
...
glmer = function(container=NULL, ..., toolkit=guiToolkit()) {
  ...
  obj = new("gLmerRGtk",block=frame,widget=frame,toolkit=toolkit,
...
setMethod(".svalue",
          signature(toolkit="guiWidgetsToolkitRGtk2",obj="gLmerRGtk"),
          function(obj, toolkit, index=NULL, drop=NULL, ...) {
...
setClass("gEditListRGtk",
         contains="gEditRGtk")

geditlist = function(...,toolkit=guiToolkit()) {
  edit = gedit(...,toolkit=toolkit)
  obj = new("gEditListRGtk", block=edit@widget@block, widget=edit@widget@widget, toolkit=toolkit)
  invisible(obj)
}


setClass("gEditNamedListRGtk",
         contains="gEditRGtk")

geditnamedlist = function(..., toolkit=guiToolkit()) {
  edit = gedit(...,toolkit=toolkit)
  obj = new("gEditNamedListRGtk", block=edit@widget@block, widget=edit@widget@widget, toolkit=toolkit)
  invisible(obj)
}
...
editFormulaDialog = function(
  ...
  if(is(data,"guiWidget") || is(data,"gComponentRGtk")) {
    data = svalue(data)
...
editSubsetDialog = function(
  ...
  ## get data values
  if(is(data,"guiComponent") || is(data,"gComponentRGtk")) {
    data = svalue(data)
  }
